classdef casadi_block_MPC_lane_merge_try_1 < matlab.System & matlab.system.mixin.Propagates & matlab.system.mixin.SampleTime
...
%            load('casadi_objects_ex4.mat');
            ...
            args.ubx(1:6:6*(casobj.N+1),1) = 25; %states upper bound - xdot
...
%                     j= casobj.target+i-1;
%                 end 
                casobj.c1 = casobj.c1 + 0.01/15;
                yaw_ref = 0; %polyval(casobj.thetax, t);
                yawdot_ref = 0; %-(pi/72)/0.01;
                xdot_ref = 10;
                ydot_ref = 0;
                
                x_ref = xd_in*casobj.c1; 
                if x_ref < x_in
                    casobj.c1 = casobj.c1 + 0.1;
                    x_ref = xd_in*casobj.c1;
                end
                y_ref = -1.5; 
