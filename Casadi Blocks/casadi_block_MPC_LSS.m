classdef casadi_block_MPC_LSS < matlab.System & matlab.system.mixin.Propagates & matlab.system.mixin.SampleTime
    ...
    methods (Access = protected)
        ...
        function setupImpl(casobj)
            ...
            casobj.path = [[linspace(100,600,900)', zeros(900,1)]; casobj.path];
