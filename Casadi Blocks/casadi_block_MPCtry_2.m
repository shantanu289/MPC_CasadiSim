classdef casadi_block_MPCtry_2 < matlab.System & matlab.system.mixin.Propagates & matlab.system.mixin.SampleTime
    ...
    methods (Access = protected)
        ...
        function setupImpl(casobj)
            ...
            load('casadi_objects_50m_try3.mat');
            import casadi.*
            ...
            %controller pars
            T =0.01; %[s]
            casobj.N = 10; %% 15 cuts now delays a bit
            casobj.Nc = 4;
            ...
            casobj.thetax = thetax;
            casobj.ppx1 = ppx1; casobj.ppy1 = ppy1;  
            casobj.ppx2 = ppx2;casobj.ppy2 = ppy2; 
            casobj.ppx3 = ppx3; casobj.ppy3 = ppy3; 
            ...
            casobj.XY4 = XY4; 
            %casobj.XY5 = XY5; 
            %casobj.XY6 = XY6; casobj.XY7 = XY7; 
            %casobj.XY8 = XY8;casobj.XY9 = XY9; casobj.XY10 = XY10;
            casobj.arc1_x = arc1_x; casobj.arc1_y = arc1_y; 
            %casobj.arc2_x = arc2_x; casobj.arc2_y = arc2_y; 
            %casobj.arc3_x = arc3_x; casobj.arc3_y=arc3_y; 
            %casobj.arc4_x = arc4_x; 
            %casobj.arc4_y = arc4_y; 
            %casobj.exit = exit;
     end
...
%                 end 
                ...
                if 3>2
                    if x_in <= casobj.XY1(1,end) 
                        pos_flag = 1;
                    else if  (x_in > casobj.XY1(2,end) && x_in <= casobj.arc1_x(1,end))
                            pos_flag = 2;
                        else if  (x_in >casobj.arc1_x(1,end) && x_in <= casobj.XY4(1,end))
                                pos_flag = 3;
...
%                 end
                ...
                if 3>2
                    if pos_flag == 1  % the trajectory end is reached
                        casobj.c1 = casobj.c1 + 0.01/2.0;
                        x_ref = polyval(casobj.ppx1, casobj.c1); y_ref = polyval(casobj.ppy1, casobj.c1);
                        x_ref = ((x_ref >= casobj.XY1(1,end)) || casobj.c1>20)*casobj.XY1(1,end) + ((casobj.c1<20)&&(x_ref<=casobj.XY1(1,end)))*x_ref;
                        y_ref = ((y_ref >= casobj.XY1(2,end)) || casobj.c1>20)*casobj.XY1(2,end) + ((casobj.c1<20)&&(y_ref<=casobj.XY1(2,end)))*y_ref;
                    else if pos_flag == 2
                            xdot_ref = 4;
                            casobj.c2 = casobj.c2 + 0.01/2.3;
                            x_ref = polyval(casobj.ppx2, casobj.c2); y_ref = polyval(casobj.ppy2, casobj.c2);
                            x_ref = ((x_ref <= casobj.arc1_x(1,end))&&(casobj.c2<=70))*x_ref + ((x_ref > casobj.arc1_x(1,end))||(casobj.c2>70))*casobj.arc1_x(1,end);
                            y_ref = ((y_ref <= casobj.arc1_y(1,end))&&(casobj.c2<=70))*y_ref + ((y_ref > casobj.arc1_y(1,end))||(casobj.c2>70))*casobj.arc1_y(1,end);
                        else if pos_flag == 3
                                xdot_ref = 3;
                                casobj.c2 = casobj.c2 + 0.01/0.01;
                                x_ref = polyval(casobj.ppx3, casobj.c3); y_ref = polyval(casobj.ppy3, casobj.c3);
                                x_ref = ((x_ref<=casobj.XY4(1,end)) && casobj.c3<=20)*x_ref + ((x_ref > casobj.XY4(1,end))|| casobj.c3>20)*casobj.XY4(1,end);
                                y_ref = ((y_ref<=casobj.XY4(2,end)) && casobj.c3<=20)*y_ref + ((y_ref > casobj.XY4(2,end))|| casobj.c3>20)*casobj.XY4(2,end);
                            else if pos_flag == 4
                                    x_ref = casobj.XY4(1,end);y_ref = casobj.XY4(2,end); yaw_ref = 0; yawdot_ref = 0; xdot_ref = 0; ydot_ref = 0;
                                end
                            end
                        end
                    end
